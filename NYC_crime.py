...
merged_df_locations = pd.merge(numerical_precincts_only, df_geo, left_on='Precinct_Number', right_on='precinct')
...
def update_map(selected_crime):
    filtered_gdf = gdf[gdf['Crime'] == selected_crime]
    ...
    map_fig = px.choropleth_mapbox(
        ...
        hover_name='Precinct',
        hover_data={'Start_date': True, 'Current': True},
